...
# third lm with years since phd instead of years of service
...
service_rank <- ggplot(faculty, aes(x = Yrs_Faculty_Service, y = Salary)) +
  geom_point(aes(color = Rank))

service_rank

since_rank <- ggplot(faculty, aes(x = Yrs_Since_PhD, y = Salary)) +
  geom_point(aes(color = Rank))
since_rank 

# Testing an interaction term for years since phd and rank

salary_lm4 <- lm(Salary ~ Rank + Yrs_Since_PhD + Sex + Discipline + Yrs_Since_PhD*Rank, data = faculty)
salary_lm4

# This IS NOT an interaction.... scrap this model
```
