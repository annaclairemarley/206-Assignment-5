...
# second model testing interaction bewtween years of service and discipline 

inttest_lm2 <- lm(Salary ~ Rank + Yrs_Faculty_Service + Sex + Discipline + Yrs_Faculty_Service*Discipline, data = faculty)
inttest_lm2
...
salary_table <- stargazer(salary_lm2, salary_lm3, inttest_lm1, type="html")
salary_table
```
